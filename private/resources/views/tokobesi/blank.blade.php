      ...
      @endphp
            ...
            <section class="wrapper site-min-height">
                    <section id="main-content">
                        ...
                        @endif
    <form action="{{ url('admin-vg/post', []) }}" enctype="multipart/form-data" method="POST">
        {{ csrf_field() }}
            <div>
            ...
            <div>
                ...
                <div class="row mt">
                    <div class="col-sm-6">
                            <input list="category"  autocomplete="off" class="form-control" placeholder="double klik to show list" id="kategori" name="category">
